...
#測試密碼
${password}    password
${cam_skywatch}    8C:51:09:D1:02:C4
...
Scroll Down To Find Element
    FOR    ${i}    IN RANGE    3
        ${elements}=    Get Webelements    xpath=//android.view.View[contains(@content-desc, "列表")]
        Run Keyword If    ${elements} != []    Exit For Loop
        Swipe By Percent    50    80    50    30    1s
    END
    Run Keyword Unless    ${elements} != []    Fail    Element not found after scrolling
...
門禁開關
    ...
    ${popup_visible}    Run Keyword And Return Status    Element Should     accessibility_id=提示\n親愛的用戶您好，為您的使用安全，門禁服務需申辦攝影機動使用
...
自動化
    ...
    Input Text    class=android.widget.EditText    robot
...
檔案
    ...
    Tap With Positions    accessibility_id=雲端錄影    400    0    1
    ...
    Should Contain    雲端錄影
    Click Element    accessibility_id=檔案\n第 4 個分頁 (共 5 個)
    Wait Until Element Is Visible    accessibility_id=全時錄影設定
    Click Element    xpath=//android.widget.FrameLayout[@resource-id="android:id/content"]/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View[1]/android.widget.Button/android.widget.Button
    #此處有bug，會先跳到帳號頁，下面四行程式碼處理
    Sleep    1s
    Click Element    xpath=//android.widget.FrameLayout[@resource-id="android:id/content"]/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View[1]/android.widget.Button/android.widget.Button
    Wait Until Element Is Visible    xpath=//android.widget.FrameLayout[@resource-id="android:id/content"]/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View[3]/android.view.View
    Click Element    xpath=//android.widget.FrameLayout[@resource-id="android:id/content"]/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View[3]/android.view.View[contains(@content-desc, ${cam_nvr})]

    Wait Until Element Is Visible    accessibility_id=${cam_nvr}
    Click Element    accessibility_id=下載
    Wait Until Element Is Visible    xpath=//android.view.View[contain(@content-desc, "確定要下載"]
    #下載驗證，包含資料夾內的檔案檢查
    Click Element    accessibility_id=下載
    Wait Until Element Is Visible    xpath=//android.view.View[contain(@content-desc, "檔案下載中"]
...
#    Scroll Element Into View    accessibility_id=版本號\nv1.2.9(6)
#    Scroll Element Into View    accessibility_id=登出
