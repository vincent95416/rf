...
新增平面圖
    ...
    Wait For Elements State    id=iframe_map    visible
    ...
    #這邊還會再調整,目前僅檢視元件是否建立成功    #這裡還需增加編輯平面圖元件的測試案例
...
報表管理
    ...
    Get Text    id=next_page_url >>> id=dropdown_nodes_btn    ==    KWH
...
虛擬設備
    ...
    Click    id=next_page_url >>> id=${device1}
    Click    id=next_page_url >>> id=${device2}
...
建立系統權限為1和2的管理者
    ...
    Click With Options    id=next_page_url >>> xpath=/html/body/div/div[6]/div[2]/form/div/div[5]/div/div[1]/ul/li[3]/a    delay=300ms    force=True
