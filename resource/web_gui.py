...
class RobotGUI(tk.Tk):
    ...
    def create_widgets(self):
        ...
        tk.Radiobutton(self, text="選擇檔案", variable=self.mode, value="file").pack()
        tk.Radiobutton(self, text="選擇資料夾", variable=self.mode, value="folder").pack()
        # 建立測試案例選擇區域
    ...
    def browse_file(self):
        ...
        if mode == "file":
            ...
            if folder_path:
                self.test_entry.delete(0, tk.END)
                self.test_entry.insert(0, folder_path)
